...
BsDatepickerEffects.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.1", ngImport: i0, type: BsDatepickerEffects, deps: [{ token: i1.BsDatepickerActions }, { token: i2.BsLocaleService }], target: i0.ɵɵFactoryTarget.Injectable });
